...
#define ALL_IN_ONE                                            3             //conflicts related
...
#define PROB_OF_CHANGE_LANE                          (1.0/4)    //(1.0/4), changing line if one has 4 chances,  from 0.25, increase to 0.5
#define MIN_LINK_NUMBER                                      1          //one route is composed of 3 links at least
...
#define MAX_ROUTE_LENGTH                         50           //max link number in a route
...
#define SLEEP_TIME                                           0        
#define A_MIN                                                   60   
#define BROADCASTING_FREQUENCY           1              //the time interval that guidance information is blinkcasted.
...
#define CHECKING_REGION                        14         //if in the "CHECKING_REGION", which begin from the beginning of link, there are ENTERING_BOUNDRY empty cells, then vehs are allowed to enter next link.
#define ENTERING_BOUNDRY                        6
...
#define COLOR_BLUE_VEH	                  RGB(0,0,128)
