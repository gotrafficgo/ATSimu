...
extern CMyObject *Node_Relation[MAX_MARGINALPOINT_NUMBER+MAX_CROSS_NUMBER][MAX_MARGINALPOINT_NUMBER+MAX_CROSS_NUMBER];	// table for network data; Max_Cross_Number is for intersection, the other for marginal points; filled based on user's input
extern CLane *Lane_Array[MAX_LINK_NUMBER][MAX_LANE_NUMBER];
...
extern Struct_Shortest_Path *Shortest_Path_Array[MAX_LINK_NUMBER][MAX_LINK_NUMBER];  
